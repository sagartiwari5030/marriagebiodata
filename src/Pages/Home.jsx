...
const Home = () => {
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="text-center md:text-left md:w-1/3">
            ...
            <div className="space-x-4">
              <Link to="/create-profile" className="bg-pink-900 text-white px-4 py-2 rounded shadow-md font-semibold">
                Create Profile
              </Link>
              <Link to="/profile-list" className="bg-pink-900 text-white px-4 py-2 rounded shadow-md font-semibold">
                View Profiles
              </Link>
            </div>
          </div>
          ...
          <div className="mt-8 md:mt-0 md:w-1/2 flex justify-center relative">
            ...
            <img
              src={heroimg1}
              alt="Card 1"
              className="absolute w-50 h-80 rounded-lg shadow-md transform -rotate-12 -left-20 top-10 z-0"
            />
            <img
              src={heroimg3}
              alt="Card 3"
              className="absolute w-50 h-80 rounded-lg shadow-md transform rotate-3 left-10 top-16 z-0"
            />
            ...
            <img
              src={heroImage}
              alt="Marriage Hero"
              className="w-96 h-96 rounded-full border-8 border-pink-500 object-cover relative z-10 -mr-10"
            />
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          ...
          <div className="bg-gradient-to-r from-pink-500 to-yellow-500 p-1 rounded-lg transform hover:scale-105 transition-transform duration-300 shadow-xl">
            <div className="bg-white p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-red-500">
                Step 1
              </h3>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-1 rounded-lg transform hover:scale-105 transition-transform duration-300 shadow-xl">
            <div className="bg-white p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-red-500">
                Step 2
              </h3>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-green-500 p-1 rounded-lg transform hover:scale-105 transition-transform duration-300 shadow-xl">
            <div className="bg-white p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-orange-500">
                Step 3
              </h3>
      ...
      <div
        className="container mx-auto ml-0 bg-cover bg-center bg-fixed"
        style={{
          backgroundImage: `url(${bgimg})`, // Replace with the path to your background image
        }}
      >
        <h2 className="text-3xl font-bold text-center mb-8 text-white">Create Your Biodata Now</h2>

        {/* Flex Container for Form and Image */}
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between rounded-lg shadow-md p-8 md:p-12 bg-opacity-80">
          {/* 3/4 Width for Form */}
          ...
          <div className="w-full md:w-1/4 flex justify-center mt-8 md:mt-0">
            <img
              src={heroimg1} // Replace with the path to your image
              alt="Profile Image"
